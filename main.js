...
const keys=new Set(),stick={x:0,y:0};let last=performance.now();const camTarget=new THREE.Vector3(0,2.15,2);const demoMode=new URLSearchParams(location.search).has('demo');
